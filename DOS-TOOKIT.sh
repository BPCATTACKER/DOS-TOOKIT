...
yellow='\033[33;1m'
clear
cowsay -f eyes " JUST THINK POSITIVE " |
lolcat
toilet -f slant " DOS TOOLKIT " |lolcat
echo
echo
echo $white"---------------------------------------"
echo $red"AUTOUR AND MODDED=2eus666GHO5T/MR.SPOON"
echo $cyan"SPECIAL THANKS TO MR.KDNS666GG05T"
echo $red"VERSION=1.2"
echo $red"BLACK PHANTOM CYBER"
echo $white"---------------------------------------"
echo $green"DOS WIN32,64 NT AND ANDROMEDA         "
echo $red"      SPECIAL ULTAH BLACK PHANTOM CYBER        "
echo $white"---------------------------------------"
echo $purple"                 LIST"
echo $white"---------------------------------------"
